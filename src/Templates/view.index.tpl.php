    ...
    <script type="text/javascript">
                ...
                "columnDefs": [
                    {
                        "render": function ( data, type, row ) {
                            return '<a href="/[[route_path]]/'+row[0]+'">'+data+'</a>';
                        },
                        "targets": 1
                    },
                    {
                        "render": function ( data, type, row ) {
                            return '<a href="/[[route_path]]/'+row[0]+'/edit" class="btn btn-default">Update</a>';
                        },
                        "targets": [[num_columns]]
                    },
                    {
        ...
        function doDelete(id) {
            if(confirm('You really want to delete this record?')) {
               $.ajax({ url: '/[[route_path]]/' + id, type: 'DELETE'}).success(function() {
                theGrid.ajax.reload();
               });
            }
            return false;
